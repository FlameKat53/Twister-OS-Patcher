...
You may have noticed that sometimes you get a little pop-up window on your desktop telling you to upgrade. If you don't want them, then simple type `crontab -e` into terminal and remove the entry ending with `patchnotify.sh`.<br>
